...
- Минималистичный интерфейс с 5 разделами: библиотека курсов, курсы в процессе, завершенные курсы, уведомления, личный кабинет
- Кнопка **«Выйти»** в верхней панели (очистка сессии и возврат на экран входа)

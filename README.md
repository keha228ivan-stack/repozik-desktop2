...
- Минималистичный интерфейс с разделами курсов и уведомлений + иконка профиля в верхней панели
- Кнопка **«Выйти»** во вкладке профиля (очистка сессии и возврат на экран входа)
